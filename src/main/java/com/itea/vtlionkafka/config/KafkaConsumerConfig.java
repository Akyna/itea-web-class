...
public class KafkaConsumerConfig {
    ...
    @Bean 
    public ConcurrentKafkaListenerContainerFactory<String, PudgeDTO> quickstartEventsListenerContainerFactory() { 
        return concurrentManualCommitContainerFactory(genericConsumerFactory(PudgeDTO.class, consumerManualCommitCommonGroupConfigs())); 
    }
