...
public class RegisteredUser extends UserModel {
    ...
    public RegisteredUser(long id, String login, String password, String fullName, String region, String gender, String comment) {
        super(id, login, password, fullName, region, gender, comment);
    }

    public RegisteredUser(long id, String login, String fullName, String region, String gender, String comment) {
        super(id, login, fullName, region, gender, comment);
    }
