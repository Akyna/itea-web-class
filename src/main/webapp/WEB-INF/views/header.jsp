...
<script type="text/javascript" src="${pageContext.request.contextPath}/static/layout/jquery.jcarousel.setup.js"></script>
    ...
    <script>
        function buy(id) {
            var str = document.getElementById("items_count" + id).value;
//        alert('Your bought ' + id + '   count: ' + str);
            $.ajax({
                type: "POST",
                url: 'cart/add',
...
/*
                ...
                var request = 'http://127.0.0.1:8080/ShopSpringMVC_war_exploded/cart/add?id=2&count=2';
      ...
      <div class="holder">
          <c:choose>
              <c:when test="${sessionScope.authenticatedUser != null}">
                  <h2 align="center">Welcome back, ${sessionScope.authenticatedUser.getFullName()}!</h2>
